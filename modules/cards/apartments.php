  ...
  <div class="grid grid-cols-<?=$row_cards_mobile?> md:grid-cols-<?=$row_cards_tablet?> lg:grid-cols-<?=$row_cards_desktop?> gap-4 items-start">
    ...
    <?php endif; ?>
            ...
            <div class="border shadow-2xl  rounded-b-xl p-4">
                ...
                <a href="<?= get_the_permalink($post_inside_cards); ?>" class="text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Book Now</a>
              </div>
            </div>
          </div>          
      </div>
